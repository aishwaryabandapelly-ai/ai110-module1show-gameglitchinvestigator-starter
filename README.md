...
- `test_results.txt` — optional test output file generated by running `pytest > test_results.txt`.
- `architecture.mmd` — optional Mermaid diagram file, only included if a project architecture diagram was created.
